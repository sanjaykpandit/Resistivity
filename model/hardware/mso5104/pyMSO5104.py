...
# mso = pyMSO5104()
# mso.open_instrument()
# mso.setup_channel(1, 0, '1', 'AC')
# mso.setup_channel(2, 0, '1', 'AC')
# mso.set_y_scale(1, 1)
# mso.set_y_scale(2, 1)
...
#
#
# for f in np.logspace(1, 5, 10):
#     mso.set_waveform_generator_frequency(f)
#     mso.set_x_scale(5/f, 0)
#
#     mso.trigger_single()
#     mso.wait_for_trigger()
#
#     x = mso.get_x_axis()
#     y1, y2 = mso.record_average_waveform([1, 2], 1)
#     wd = WaveformData()
#     wd.set_data(100, x, array([y1, y2]), 1000, 10)
#     cs = CosFit(wd)
#     p = cs.get_parameter()
#     print(p[0][1], p[1][1], f)
#     v = cs.get_series_using_parameters(p, x)
#
# mso.close()
#
# plt.plot(x, y1, 'r.')
